...
def _ics214_auto_entry(
    ...
    *,
    ...
    normalized_actor_user_id = None if actor_user_id in (None, "") else str(actor_user_id)
    ics.add_entry(
        inc, stream_id,
        EntryCreate(text=text, source=source, actor_user_id=normalized_actor_user_id),
        autogenerated=True,
    )
