...
| `bridge/incident_bridge.py` | Task narrative | **Done 2026-07-03; storage tightened 2026-07-11** — calls `GET/POST/PATCH/DELETE /api/incidents/{id}/narratives`; `task_narratives.py` now embeds entries in `tasks.narrative` through a task `BaseRepository` subclass | — |
